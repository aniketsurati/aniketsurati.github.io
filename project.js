const projects = {
    ...
    "manchester-united": {
        ...
        research: "Our research focused on discovering the <b>best-in-class D2C strategies</b> across industries and assessing their applicability to Manchester United. We conducted:<br><br> 1. <b>Benchmarking</b> against clubs and leagues such as <b>La Liga, Japanese J.League, NBA, NFL, UFC, and IPL</b>, identifying D2C initiatives that successfully monetized fan engagement.<br><br> 2. <b>Market segmentation & localization</b> to understand the unique preferences of fans across different geographies, particularly in <b>high-growth markets like India, Nigeria, and the US</b>.<br><br> 3. <b>Financial modeling</b> to estimate potential revenue from various D2C initiatives, balancing <b>short-term vs. long-term impact, fan engagement, operational complexity, and cost structure</b>.<br><br> 4. <b>Stakeholder interviews</b> with internal teams (Media, Data & Analytics, Customer Acquisition) to align the strategy with Manchester United’s existing digital and commercial assets.",
        planning: "Based on our research, we developed a <b>comprehensive D2C roadmap</b>, focusing on initiatives that could maximize revenue while <b>enhancing fan engagement</b>. Our <b>tiered membership model</b> became the foundation for all offerings, integrating:<br><br> 1. <b>Digital products</b>: A <b>revamped Man Utd app</b> with premium content, live interactions, and exclusive fan-led features.<br><br> 2. <b>Physical experiences</b>: Man Utd pop-up hubs in key cities worldwide to create <b>localized matchday experiences</b> and increase direct fan interaction.<br><br> 3. <b>E-commerce expansion</b>: A <b>localized and customized retail platform</b>, ensuring global fans had access to tailored merchandise, payment options, and fulfillment services.<br><br> 4. Masterclass programs: Exclusive multi-part courses featuring players, coaches, nutritionists, and sports scientists, offering fans an immersive learning experience.<br><br> 5. <b>VR/AR-powered stadium experiences</b>: Creating <b>virtual Old Trafford experiences</b> in international markets using AR/VR to replicate live matchday atmospheres.<br><br> We structured our <b>implementation roadmap</b> into short-term and long-term initiatives, ensuring that revenue opportunities could be realized <b>within five years</b> while gradually <b>expanding digital infrastructure and operational capabilities</b>.",
        development: "Executing this strategy required Manchester United to <b>streamline its internal digital ecosystem and enhance its technological capabilities</b>. We recommended:<br><br> 1. <b>A unified fan membership system</b> integrating MUTV, the Man Utd app, e-commerce, and digital content.<br><br> 2. <b>Localized market presence</b> by setting up regional hubs and partnerships to drive engagement in high-growth markets.<br><br> 3. <b>Cross-functional alignment</b> between media, retail, and club marketing to create a <b>consistent, high-quality D2C experience</b>.<br><br> To support these initiatives, we outlined the <b>necessary investments in content creation, digital platform enhancements, and international infrastructure</b> while optimizing costs through strategic outsourcing and licensing partnerships.",
